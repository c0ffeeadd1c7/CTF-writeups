...
![Pasted image 20240528012106.png]({{ site.baseurl  }}/assets/Pasted%20image%2020240528012106.png)  
The size of the RIFF header was different from the example turns out doesnt matter.  
![Pasted image 20240528014252.png]({{ site.baseurl  }}/assets/Pasted%20image%2020240528014252.png)  
![Pasted image 20240528014259.png]({{ site.baseurl  }}/assets/Pasted%20image%2020240528014259.png)  
